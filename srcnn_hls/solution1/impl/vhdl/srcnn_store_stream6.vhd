...
attribute shreg_extract : string;
    ...
    signal icmp_ln734_fu_308_p2 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal zext_ln732_fu_192_p1 : STD_LOGIC_VECTOR (9 downto 0);
    signal zext_ln732_reg_345 : STD_LOGIC_VECTOR (9 downto 0);
    signal zext_ln732_1_fu_204_p1 : STD_LOGIC_VECTOR (21 downto 0);
    signal zext_ln732_1_reg_350 : STD_LOGIC_VECTOR (21 downto 0);
    signal zext_ln732_2_fu_208_p1 : STD_LOGIC_VECTOR (31 downto 0);
    signal zext_ln732_2_reg_355 : STD_LOGIC_VECTOR (31 downto 0);
    signal add_ln732_fu_229_p2 : STD_LOGIC_VECTOR (7 downto 0);
    signal add_ln732_reg_363 : STD_LOGIC_VECTOR (7 downto 0);
    signal ap_CS_fsm_state2 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state2 : signal is "none";
    signal gmem_out_addr_reg_368 : STD_LOGIC_VECTOR (63 downto 0);
    signal icmp_ln732_fu_224_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal add_ln734_fu_313_p2 : STD_LOGIC_VECTOR (7 downto 0);
    signal add_ln734_reg_377 : STD_LOGIC_VECTOR (7 downto 0);
    signal ap_block_state4 : BOOLEAN;
    signal s_out_i_read_reg_382 : STD_LOGIC_VECTOR (31 downto 0);
    signal x_reg_149 : STD_LOGIC_VECTOR (7 downto 0);
    signal sext_ln734_fu_298_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal y_fu_100 : STD_LOGIC_VECTOR (7 downto 0);
    signal add_ln962_fu_160_p2 : STD_LOGIC_VECTOR (8 downto 0);
    signal trunc_ln961_fu_174_p1 : STD_LOGIC_VECTOR (7 downto 0);
    signal tmp_2_fu_166_p3 : STD_LOGIC_VECTOR (0 downto 0);
    signal xor_ln962_fu_178_p2 : STD_LOGIC_VECTOR (7 downto 0);
    signal tmp_1_fu_196_p3 : STD_LOGIC_VECTOR (9 downto 0);
    signal zext_ln732_3_fu_220_p1 : STD_LOGIC_VECTOR (9 downto 0);
...
begin
        ...
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                ...
                if ((ap_continue = ap_const_logic_1)) then 
                    ap_done_reg <= ap_const_logic_0;
                elsif (((ap_const_logic_1 = ap_CS_fsm_state2) and (icmp_ln732_fu_224_p2 = ap_const_lv1_1))) then 
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            ...
            elsif ((not(((s_out_i_empty_n = ap_const_logic_0) and (icmp_ln734_fu_308_p2 = ap_const_lv1_0))) and (ap_const_logic_1 = ap_CS_fsm_state4) and (icmp_ln734_fu_308_p2 = ap_const_lv1_1))) then 
                y_fu_100 <= add_ln732_reg_363;
            end if; 
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = ap_CS_fsm_state2)) then
                add_ln732_reg_363 <= add_ln732_fu_229_p2;
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((not(((s_out_i_empty_n = ap_const_logic_0) and (icmp_ln734_fu_308_p2 = ap_const_lv1_0))) and (ap_const_logic_1 = ap_CS_fsm_state4))) then
                add_ln734_reg_377 <= add_ln734_fu_313_p2;
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_state2) and (icmp_ln732_fu_224_p2 = ap_const_lv1_0))) then
                gmem_out_addr_reg_368 <= sext_ln734_fu_298_p1;
            end if;
        end if;
    end process;
    process (ap_clk)
        ...
        if (ap_clk'event and ap_clk = '1') then
            if ((not(((output_ftmap_empty_n = ap_const_logic_0) or (ap_done_reg = ap_const_logic_1) or (ap_start = ap_const_logic_0) or (tw_eff_loc_i_empty_n = ap_const_logic_0) or (w0_empty_n = ap_const_logic_0) or (h0_empty_n = ap_const_logic_0))) and (ap_const_logic_1 = ap_CS_fsm_state1))) then
                ...
                tw_eff_reg_335 <= tw_eff_loc_i_dout;
                    zext_ln732_1_reg_350(9 downto 2) <= zext_ln732_1_fu_204_p1(9 downto 2);
                    zext_ln732_2_reg_355(7 downto 0) <= zext_ln732_2_fu_208_p1(7 downto 0);
                    zext_ln732_reg_345(8 downto 0) <= zext_ln732_fu_192_p1(8 downto 0);
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((not(((s_out_i_empty_n = ap_const_logic_0) and (icmp_ln734_fu_308_p2 = ap_const_lv1_0))) and (ap_const_logic_1 = ap_CS_fsm_state4) and (icmp_ln734_fu_308_p2 = ap_const_lv1_0))) then
                s_out_i_read_reg_382 <= s_out_i_dout;
            end if;
        end if;
    end process;
    zext_ln732_reg_345(9) <= '0';
    zext_ln732_1_reg_350(1 downto 0) <= "00";
    zext_ln732_1_reg_350(21 downto 10) <= "000000000000";
    zext_ln732_2_reg_355(31 downto 8) <= "000000000000000000000000";

    ap_NS_fsm_assign_proc : process (ap_start, ap_done_reg, ap_CS_fsm, ap_CS_fsm_state1, s_out_i_empty_n, m_axi_gmem_out_AWREADY, m_axi_gmem_out_WREADY, m_axi_gmem_out_BVALID, output_ftmap_empty_n, h0_empty_n, w0_empty_n, tw_eff_loc_i_empty_n, ap_CS_fsm_state4, icmp_ln734_fu_308_p2, ap_CS_fsm_state3, ap_CS_fsm_state5, ap_CS_fsm_state10, ap_CS_fsm_state2, icmp_ln732_fu_224_p2)
    begin
        case ap_CS_fsm is
            ...
            when ap_ST_fsm_state2 => 
                if (((ap_const_logic_1 = ap_CS_fsm_state2) and (icmp_ln732_fu_224_p2 = ap_const_lv1_1))) then
                    ap_NS_fsm <= ap_ST_fsm_state1;
                else
            ...
            when ap_ST_fsm_state4 => 
                if ((not(((s_out_i_empty_n = ap_const_logic_0) and (icmp_ln734_fu_308_p2 = ap_const_lv1_0))) and (ap_const_logic_1 = ap_CS_fsm_state4) and (icmp_ln734_fu_308_p2 = ap_const_lv1_1))) then
                    ap_NS_fsm <= ap_ST_fsm_state6;
                elsif ((not(((s_out_i_empty_n = ap_const_logic_0) and (icmp_ln734_fu_308_p2 = ap_const_lv1_0))) and (ap_const_logic_1 = ap_CS_fsm_state4) and (icmp_ln734_fu_308_p2 = ap_const_lv1_0))) then
    ...
    add_ln732_fu_229_p2 <= std_logic_vector(unsigned(y_fu_100) + unsigned(ap_const_lv8_1));
    add_ln734_fu_313_p2 <= std_logic_vector(unsigned(x_reg_149) + unsigned(ap_const_lv8_1));
    add_ln962_fu_160_p2 <= std_logic_vector(unsigned(h0_dout) + unsigned(ap_const_lv9_10));
    ...
    ap_ST_fsm_state4_blk_assign_proc : process(s_out_i_empty_n, icmp_ln734_fu_308_p2)
    begin
        if (((s_out_i_empty_n = ap_const_logic_0) and (icmp_ln734_fu_308_p2 = ap_const_lv1_0))) then 
    ...
    ap_block_state4_assign_proc : process(s_out_i_empty_n, icmp_ln734_fu_308_p2)
    begin
                ap_block_state4 <= ((s_out_i_empty_n = ap_const_logic_0) and (icmp_ln734_fu_308_p2 = ap_const_lv1_0));
    end process;


    ap_done_assign_proc : process(ap_done_reg, ap_CS_fsm_state2, icmp_ln732_fu_224_p2)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state2) and (icmp_ln732_fu_224_p2 = ap_const_lv1_1))) then 
    ...
    ap_ready_assign_proc : process(ap_CS_fsm_state2, icmp_ln732_fu_224_p2)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state2) and (icmp_ln732_fu_224_p2 = ap_const_lv1_1))) then 
    ...
    empty_fu_235_p2 <= std_logic_vector(unsigned(zext_ln732_reg_345) + unsigned(zext_ln732_3_fu_220_p1));
    ...
    icmp_ln732_fu_224_p2 <= "1" when (y_fu_100 = th_eff_reg_340) else "0";
    icmp_ln734_fu_308_p2 <= "1" when (x_reg_149 = tw_eff_reg_335) else "0";
    ...
    m_axi_gmem_out_AWLEN <= zext_ln732_2_reg_355;
    ...
    s_out_i_blk_n_assign_proc : process(s_out_i_empty_n, ap_CS_fsm_state4, icmp_ln734_fu_308_p2)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state4) and (icmp_ln734_fu_308_p2 = ap_const_lv1_0))) then 
    ...
    s_out_i_read_assign_proc : process(s_out_i_empty_n, ap_CS_fsm_state4, icmp_ln734_fu_308_p2)
    begin
        if ((not(((s_out_i_empty_n = ap_const_logic_0) and (icmp_ln734_fu_308_p2 = ap_const_lv1_0))) and (ap_const_logic_1 = ap_CS_fsm_state4) and (icmp_ln734_fu_308_p2 = ap_const_lv1_0))) then 
        ...
        sext_ln734_fu_298_p1 <= std_logic_vector(IEEE.numeric_std.resize(signed(trunc_ln1_fu_288_p4),64));

    th_eff_fu_184_p3 <= 
        xor_ln962_fu_178_p2 when (tmp_2_fu_166_p3(0) = '1') else 
        ap_const_lv8_10;
    tmp_1_fu_196_p3 <= (w0_dout & ap_const_lv2_0);
    tmp_2_fu_166_p3 <= add_ln962_fu_160_p2(8 downto 8);
        tmp_cast_fu_279_p1 <= std_logic_vector(IEEE.numeric_std.resize(signed(tmp_fu_274_p2),64));

    tmp_fu_274_p2 <= std_logic_vector(signed(p_cast_fu_270_p1) + signed(zext_ln732_1_reg_350));
    trunc_ln1_fu_288_p4 <= empty_66_fu_283_p2(63 downto 2);
    trunc_ln961_fu_174_p1 <= h0_dout(8 - 1 downto 0);
    ...
    xor_ln962_fu_178_p2 <= (trunc_ln961_fu_174_p1 xor ap_const_lv8_FF);
    zext_ln732_1_fu_204_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_1_fu_196_p3),22));
    zext_ln732_2_fu_208_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tw_eff_loc_i_dout),32));
    zext_ln732_3_fu_220_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(y_fu_100),10));
    zext_ln732_fu_192_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(h0_dout),10));
end behav;
