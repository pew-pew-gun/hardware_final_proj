...
module srcnn_srcnn_Pipeline_VITIS_LOOP_374_8_VITIS_LOOP_375_9_VITIS_LOOP_377_10 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
wire   [0:0] icmp_ln375_fu_305_p2;
reg   [0:0] icmp_ln375_reg_555;
reg   [31:0] gmem_w3_addr_read_reg_563;
reg    ap_condition_exit_pp0_iter1_stage0;
wire   [63:0] zext_ln379_3_fu_467_p1;
reg   [2:0] kx_fu_112;
wire   [2:0] add_ln377_fu_490_p2;
wire    ap_loop_init;
reg   [2:0] ky_fu_116;
wire   [2:0] select_ln375_1_fu_421_p3;
reg   [5:0] indvar_flatten6_fu_120;
wire   [5:0] select_ln375_2_fu_317_p3;
reg   [5:0] i3_fu_124;
wire   [5:0] select_ln374_1_fu_352_p3;
reg   [9:0] indvar_flatten19_fu_128;
wire   [9:0] add_ln374_1_fu_285_p2;
reg   [9:0] ap_sig_allocacmp_indvar_flatten19_load;
wire   [2:0] trunc_ln374_fu_359_p1;
wire   [31:0] bitcast_ln379_fu_479_p1;
wire   [5:0] add_ln375_1_fu_311_p2;
wire   [5:0] add_ln374_fu_339_p2;
wire   [1:0] zext_ln374_mid2_v_fu_363_p4;
wire   [3:0] or_ln_fu_373_p3;
wire   [0:0] icmp_ln377_fu_390_p2;
wire   [0:0] xor_ln374_fu_385_p2;
wire   [2:0] select_ln374_fu_345_p3;
wire   [0:0] and_ln374_fu_396_p2;
wire   [0:0] or_ln375_fu_408_p2;
wire   [2:0] add_ln375_fu_402_p2;
wire   [4:0] zext_ln375_fu_381_p1;
wire   [4:0] zext_ln379_fu_429_p1;
wire   [4:0] add_ln379_fu_433_p2;
wire   [6:0] p_shl_fu_443_p3;
wire   [6:0] zext_ln379_1_fu_439_p1;
wire   [2:0] select_ln375_fu_413_p3;
wire   [6:0] add_ln379_1_fu_451_p2;
wire   [6:0] zext_ln379_2_fu_457_p1;
wire   [6:0] add_ln379_2_fu_461_p2;
reg    ap_done_reg;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((ap_enable_reg_pp0_iter0 == 1'b1) & (icmp_ln374_fu_279_p2 == 1'd0))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        end else if (((icmp_ln374_reg_551 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln374_reg_551 == 1'd0) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln374_fu_279_p2 == 1'd1))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_subdone) & (icmp_ln374_reg_551 == 1'd1) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0) & (icmp_ln374_reg_551 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln374_reg_551 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter2 == 1'b1) & (trunc_ln374_fu_359_p1 == 3'd1))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter2 == 1'b1) & (trunc_ln374_fu_359_p1 == 3'd7))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter2 == 1'b1) & (trunc_ln374_fu_359_p1 == 3'd6))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter2 == 1'b1) & (trunc_ln374_fu_359_p1 == 3'd5))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter2 == 1'b1) & (trunc_ln374_fu_359_p1 == 3'd4))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter2 == 1'b1) & (trunc_ln374_fu_359_p1 == 3'd3))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter2 == 1'b1) & (trunc_ln374_fu_359_p1 == 3'd0))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter2 == 1'b1) & (trunc_ln374_fu_359_p1 == 3'd2))) begin
...
assign add_ln374_1_fu_285_p2 = (ap_sig_allocacmp_indvar_flatten19_load + 10'd1);

assign add_ln374_fu_339_p2 = (i3_fu_124 + 6'd1);

assign add_ln375_1_fu_311_p2 = (indvar_flatten6_fu_120 + 6'd1);

assign add_ln375_fu_402_p2 = (select_ln374_fu_345_p3 + 3'd1);

assign add_ln377_fu_490_p2 = (select_ln375_fu_413_p3 + 3'd1);

assign add_ln379_1_fu_451_p2 = (p_shl_fu_443_p3 + zext_ln379_1_fu_439_p1);

assign add_ln379_2_fu_461_p2 = (add_ln379_1_fu_451_p2 + zext_ln379_2_fu_457_p1);

assign add_ln379_fu_433_p2 = (zext_ln375_fu_381_p1 + zext_ln379_fu_429_p1);

assign and_ln374_fu_396_p2 = (xor_ln374_fu_385_p2 & icmp_ln377_fu_390_p2);
...
always @ (*) begin
    ap_block_pp0_stage0_11001 = ((icmp_ln374_reg_551 == 1'd0) & (m_axi_gmem_w3_RVALID == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1));
end

always @ (*) begin
    ap_block_pp0_stage0_subdone = ((icmp_ln374_reg_551 == 1'd0) & (m_axi_gmem_w3_RVALID == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1));
end

assign ap_block_state1_pp0_stage0_iter0 = ~(1'b1 == 1'b1);

always @ (*) begin
    ap_block_state2_pp0_stage0_iter1 = ((icmp_ln374_reg_551 == 1'd0) & (m_axi_gmem_w3_RVALID == 1'b0));
end
...
assign bitcast_ln379_fu_479_p1 = gmem_w3_addr_read_reg_563;

assign icmp_ln374_fu_279_p2 = ((ap_sig_allocacmp_indvar_flatten19_load == 10'd800) ? 1'b1 : 1'b0);

assign icmp_ln375_fu_305_p2 = ((indvar_flatten6_fu_120 == 6'd25) ? 1'b1 : 1'b0);

assign icmp_ln377_fu_390_p2 = ((kx_fu_112 == 3'd5) ? 1'b1 : 1'b0);
...
assign or_ln375_fu_408_p2 = (icmp_ln375_reg_555 | and_ln374_fu_396_p2);

assign or_ln_fu_373_p3 = {{zext_ln374_mid2_v_fu_363_p4}, {zext_ln374_mid2_v_fu_363_p4}};

assign p_shl_fu_443_p3 = {{add_ln379_fu_433_p2}, {2'd0}};

assign select_ln374_1_fu_352_p3 = ((icmp_ln375_reg_555[0:0] == 1'b1) ? add_ln374_fu_339_p2 : i3_fu_124);

assign select_ln374_fu_345_p3 = ((icmp_ln375_reg_555[0:0] == 1'b1) ? 3'd0 : ky_fu_116);

assign select_ln375_1_fu_421_p3 = ((and_ln374_fu_396_p2[0:0] == 1'b1) ? add_ln375_fu_402_p2 : select_ln374_fu_345_p3);

assign select_ln375_2_fu_317_p3 = ((icmp_ln375_fu_305_p2[0:0] == 1'b1) ? 6'd1 : add_ln375_1_fu_311_p2);

assign select_ln375_fu_413_p3 = ((or_ln375_fu_408_p2[0:0] == 1'b1) ? 3'd0 : kx_fu_112);

assign srcnn_float_255_255_float_1_9_9_float_float_64_1_1_f_1_address0 = zext_ln379_3_fu_467_p1;

assign srcnn_float_255_255_float_1_9_9_float_float_64_1_1_f_1_d0 = bitcast_ln379_fu_479_p1;

assign srcnn_float_255_255_float_1_9_9_float_float_64_1_1_f_2_address0 = zext_ln379_3_fu_467_p1;

assign srcnn_float_255_255_float_1_9_9_float_float_64_1_1_f_2_d0 = bitcast_ln379_fu_479_p1;

assign srcnn_float_255_255_float_1_9_9_float_float_64_1_1_f_3_address0 = zext_ln379_3_fu_467_p1;

assign srcnn_float_255_255_float_1_9_9_float_float_64_1_1_f_3_d0 = bitcast_ln379_fu_479_p1;

assign srcnn_float_255_255_float_1_9_9_float_float_64_1_1_f_4_address0 = zext_ln379_3_fu_467_p1;

assign srcnn_float_255_255_float_1_9_9_float_float_64_1_1_f_4_d0 = bitcast_ln379_fu_479_p1;

assign srcnn_float_255_255_float_1_9_9_float_float_64_1_1_f_5_address0 = zext_ln379_3_fu_467_p1;

assign srcnn_float_255_255_float_1_9_9_float_float_64_1_1_f_5_d0 = bitcast_ln379_fu_479_p1;

assign srcnn_float_255_255_float_1_9_9_float_float_64_1_1_f_6_address0 = zext_ln379_3_fu_467_p1;

assign srcnn_float_255_255_float_1_9_9_float_float_64_1_1_f_6_d0 = bitcast_ln379_fu_479_p1;

assign srcnn_float_255_255_float_1_9_9_float_float_64_1_1_f_7_address0 = zext_ln379_3_fu_467_p1;

assign srcnn_float_255_255_float_1_9_9_float_float_64_1_1_f_7_d0 = bitcast_ln379_fu_479_p1;

assign srcnn_float_255_255_float_1_9_9_float_float_64_1_1_f_address0 = zext_ln379_3_fu_467_p1;

assign srcnn_float_255_255_float_1_9_9_float_float_64_1_1_f_d0 = bitcast_ln379_fu_479_p1;

assign trunc_ln374_fu_359_p1 = select_ln374_1_fu_352_p3[2:0];

assign xor_ln374_fu_385_p2 = (icmp_ln375_reg_555 ^ 1'd1);

assign zext_ln374_mid2_v_fu_363_p4 = {{select_ln374_1_fu_352_p3[4:3]}};

assign zext_ln375_fu_381_p1 = or_ln_fu_373_p3;

assign zext_ln379_1_fu_439_p1 = add_ln379_fu_433_p2;

assign zext_ln379_2_fu_457_p1 = select_ln375_fu_413_p3;

assign zext_ln379_3_fu_467_p1 = add_ln379_2_fu_461_p2;

assign zext_ln379_fu_429_p1 = select_ln375_1_fu_421_p3;

endmodule //srcnn_srcnn_Pipeline_VITIS_LOOP_374_8_VITIS_LOOP_375_9_VITIS_LOOP_377_10
