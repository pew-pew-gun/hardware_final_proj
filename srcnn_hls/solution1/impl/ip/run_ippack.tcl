...
set IPName      "srcnn"
set Version     "1.0"
set DisplayName "Srcnn"
set Revision    "2114311966"
...
set xo_kernel_name "srcnn"
set xo_kernel_files {}
set enable_xo_gen false
set kernel_xml [file join [pwd] ../kernel/kernel.xml]
set solution_dir "C:/Users/redre/Desktop/Hardware_Accelerated_Computing/FinalProject/golden/srcnn_hls/solution1"
set debug_dir "C:/Users/redre/Desktop/Hardware_Accelerated_Computing/FinalProject/golden/srcnn_hls/solution1/.debug"
set xo_hls_files_dir ""
set hdl_module_list {srcnn_flow_control_loop_pipe_sequential_init
...
srcnn_dataflow_in_loop_VITIS_LOOP_400_12_inbuf_RAM_1P_BRAM_1R1W_memcore
srcnn_dataflow_in_loop_VITIS_LOOP_400_12_inbuf_RAM_1P_BRAM_1R1W
srcnn_dataflow_in_loop_VITIS_LOOP_400_12_outbuf_RAM_1P_BRAM_1R1W_memcore
...
set Interfaces {
    s_axi_ctrl {
        ...
        registers {{0x00 CTRL RW 0x0 {Control signals} {{ 0 1 AP_START RW 0 "Control signal Register for 'ap_start'." } { 1 1 AP_DONE R 0 "Control signal Register for 'ap_done'." } { 2 1 AP_IDLE R 0 "Control signal Register for 'ap_idle'." } { 3 1 AP_READY R 0 "Control signal Register for 'ap_ready'." } { 4 3 RESERVED_1 R 0 "Reserved.  0s on read." } { 7 1 AUTO_RESTART RW 0 "Control signal Register for 'auto_restart'." } { 8 1 RESERVED_2 R 0 "Reserved.  0s on read." } { 9 1 INTERRUPT R 0 "Control signal Register for 'interrupt'." } { 10 22 RESERVED_3 R 0 "Reserved.  0s on read." }}} {0x04 GIER RW 0x0 {Global Interrupt Enable Register} {{ 0 1 Enable RW 0 "Master enable for the device interrupt output to the system interrupt controller: 0 = Disabled, 1 = Enabled" } { 1 31 RESERVED R 0 "Reserved.  0s on read." }}} {0x08 IP_IER RW 0x0 {IP Interrupt Enable Register} {{0 1 CHAN0_INT_EN RW 0 {Enable Channel 0 (ap_done) Interrupt.  0 = Disabled, 1 = Enabled.}} {1 1 CHAN1_INT_EN RW 0 {Enable Channel 1 (ap_ready) Interrupt.  0 = Disabled, 1 = Enabled.}} {2 30 RESERVED_0 R 0 {Reserved.  0s on read.}}}} {0x0c IP_ISR RW 0x0 {IP Interrupt Status Register} {{0 1 CHAN0_INT_ST RTOW 0 {Channel 0 (ap_done) Interrupt Status. 0 = No Channel 0 interrupt, 1 = Channel 0 interrupt.}} {1 1 CHAN1_INT_ST RTOW 0 {Channel 1 (ap_ready) Interrupt Status. 0 = No Channel 1 interrupt, 1 = Channel 1 interrupt.}} {2 30 RESERVED_0 R 0 {Reserved.  0s on read.}}}} {0x10 input_ftmap_1 W 0x0 "Data signal of input_ftmap" {{0 32 input_ftmap W 0 "Bit 31 to 0 of input_ftmap"}}} {0x14 input_ftmap_2 W 0x0 "Data signal of input_ftmap" {{0 32 input_ftmap W 0 "Bit 63 to 32 of input_ftmap"}}} {0x1c conv1_weights_1 W 0x0 "Data signal of conv1_weights" {{0 32 conv1_weights W 0 "Bit 31 to 0 of conv1_weights"}}} {0x20 conv1_weights_2 W 0x0 "Data signal of conv1_weights" {{0 32 conv1_weights W 0 "Bit 63 to 32 of conv1_weights"}}} {0x28 conv1_biases_1 W 0x0 "Data signal of conv1_biases" {{0 32 conv1_biases W 0 "Bit 31 to 0 of conv1_biases"}}} {0x2c conv1_biases_2 W 0x0 "Data signal of conv1_biases" {{0 32 conv1_biases W 0 "Bit 63 to 32 of conv1_biases"}}} {0x34 conv2_weights_1 W 0x0 "Data signal of conv2_weights" {{0 32 conv2_weights W 0 "Bit 31 to 0 of conv2_weights"}}} {0x38 conv2_weights_2 W 0x0 "Data signal of conv2_weights" {{0 32 conv2_weights W 0 "Bit 63 to 32 of conv2_weights"}}} {0x40 conv2_biases_1 W 0x0 "Data signal of conv2_biases" {{0 32 conv2_biases W 0 "Bit 31 to 0 of conv2_biases"}}} {0x44 conv2_biases_2 W 0x0 "Data signal of conv2_biases" {{0 32 conv2_biases W 0 "Bit 63 to 32 of conv2_biases"}}} {0x4c conv3_weights_1 W 0x0 "Data signal of conv3_weights" {{0 32 conv3_weights W 0 "Bit 31 to 0 of conv3_weights"}}} {0x50 conv3_weights_2 W 0x0 "Data signal of conv3_weights" {{0 32 conv3_weights W 0 "Bit 63 to 32 of conv3_weights"}}} {0x58 conv3_biases_1 W 0x0 "Data signal of conv3_biases" {{0 32 conv3_biases W 0 "Bit 31 to 0 of conv3_biases"}}} {0x5c conv3_biases_2 W 0x0 "Data signal of conv3_biases" {{0 32 conv3_biases W 0 "Bit 63 to 32 of conv3_biases"}}} {0x64 output_ftmap_1 W 0x0 "Data signal of output_ftmap" {{0 32 output_ftmap W 0 "Bit 31 to 0 of output_ftmap"}}} {0x68 output_ftmap_2 W 0x0 "Data signal of output_ftmap" {{0 32 output_ftmap W 0 "Bit 63 to 32 of output_ftmap"}}}}
        memories ""
        ctype {
            AWVALID {
                Type "bool"
    ...
    ap_clk {
        ...
        buses "s_axi_ctrl m_axi_gmem_in m_axi_gmem_w1 m_axi_gmem_w2 m_axi_gmem_w3 m_axi_gmem_out"
        reset "ap_rst_n"
    }
    ap_rst_n {
        type "reset"
    ...
    m_axi_gmem_in {
        ...
        data_width "32"
        port_prefix "m_axi_gmem_in"
        param_prefix "C_M_AXI_GMEM_IN"
    ...
    m_axi_gmem_w1 {
        ...
        data_width "32"
        port_prefix "m_axi_gmem_w1"
        param_prefix "C_M_AXI_GMEM_W1"
        port_width "AWADDR 64 AWID 1 AWUSER 1 WDATA 32 WSTRB 4 WID 1 WUSER 1 ARADDR 64 ARID 1 ARUSER 1 RDATA 32 RID 1 RUSER 1 BID 1 BUSER 1"
        HasOffset "1"
        has_dependant_on "1"
        offset_slave_name "s_axi_ctrl"
    ...
    m_axi_gmem_w2 {
        ...
        data_width "32"
        port_prefix "m_axi_gmem_w2"
        param_prefix "C_M_AXI_GMEM_W2"
        port_width "AWADDR 64 AWID 1 AWUSER 1 WDATA 32 WSTRB 4 WID 1 WUSER 1 ARADDR 64 ARID 1 ARUSER 1 RDATA 32 RID 1 RUSER 1 BID 1 BUSER 1"
        HasOffset "1"
        has_dependant_on "1"
        offset_slave_name "s_axi_ctrl"
    ...
    m_axi_gmem_w3 {
        ...
        data_width "32"
        port_prefix "m_axi_gmem_w3"
        param_prefix "C_M_AXI_GMEM_W3"
        port_width "AWADDR 64 AWID 1 AWUSER 1 WDATA 32 WSTRB 4 WID 1 WUSER 1 ARADDR 64 ARID 1 ARUSER 1 RDATA 32 RID 1 RUSER 1 BID 1 BUSER 1"
        HasOffset "1"
        has_dependant_on "1"
        offset_slave_name "s_axi_ctrl"
...
source -notrace "C:/Xilinx/Vitis_HLS/2023.1/common/scripts/ipxhls.tcl"
