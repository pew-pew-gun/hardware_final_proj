...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.srcnn.autotvin_gmem_in.dat"
         "c.srcnn.autotvin_gmem_w1.dat"
         "c.srcnn.autotvin_gmem_w2.dat"
         "c.srcnn.autotvin_gmem_w3.dat"
         "c.srcnn.autotvin_input_ftmap.dat"
         "c.srcnn.autotvin_conv1_weights.dat"
         "c.srcnn.autotvin_conv1_biases.dat"
         "c.srcnn.autotvin_conv2_weights.dat"
         "c.srcnn.autotvin_conv2_biases.dat"
         "c.srcnn.autotvin_conv3_weights.dat"
         "c.srcnn.autotvin_conv3_biases.dat"
         "c.srcnn.autotvin_output_ftmap.dat"
         "c.srcnn.autotvin_reload_weights.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.srcnn.autotvout_gmem_out.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
