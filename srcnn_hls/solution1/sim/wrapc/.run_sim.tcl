...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "srcnn.autotvin.dat"
	set constFileTvOut       "srcnn.autotvout.dat"
	set constFileHdlTvIn     "srcnn.autohdltvin.dat"
	set constFileHdlTvOut    "srcnn.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
