...
`timescale 1ns/1ps
module srcnn_dataflow_in_loop_IT_w0_p_ZZ5srcnnPA255_A255_fPA1_A9_A9_fPfPA64_A1_A1_fS6_PA32bkb
#(parameter
    DataWidth    = 32,
    AddressRange = 2,
    AddressWidth = 1,
...
generate
    for (i = 0; i < BufferCount; i = i + 1) begin : gen_buffer
        srcnn_dataflow_in_loop_IT_w0_p_ZZ5srcnnPA255_A255_fPA1_A9_A9_fPfPA64_A1_A1_fS6_PA32bkb_memcore srcnn_dataflow_in_loop_IT_w0_p_ZZ5srcnnPA255_A255_fPA1_A9_A9_fPfPA64_A1_A1_fS6_PA32bkb_memcore_U (
            .ce0      ( buf_ce0[i] ),
            .address0 ( buf_a0[i] ),
            .q0       ( buf_q0[i] ),
            .ce1      ( buf_ce1[i] ),
