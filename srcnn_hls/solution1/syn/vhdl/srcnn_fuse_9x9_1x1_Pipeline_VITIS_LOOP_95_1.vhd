...
entity srcnn_fuse_9x9_1x1_Pipeline_VITIS_LOOP_95_1 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of srcnn_fuse_9x9_1x1_Pipeline_VITIS_LOOP_95_1 is 
...
attribute shreg_extract : string;
    ...
    signal zext_ln95_fu_450_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal n2_fu_120 : STD_LOGIC_VECTOR (5 downto 0);
    signal add_ln95_fu_918_p2 : STD_LOGIC_VECTOR (5 downto 0);
    ...
    signal trunc_ln95_fu_436_p1 : STD_LOGIC_VECTOR (4 downto 0);
...
begin
    ...
    mux_25_5_32_1_1_U263 : component srcnn_mux_25_5_32_1_1
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        din0_WIDTH => 32,
    ...
    mux_25_5_32_1_1_U264 : component srcnn_mux_25_5_32_1_1
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        din0_WIDTH => 32,
    ...
    mux_25_5_32_1_1_U265 : component srcnn_mux_25_5_32_1_1
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        din0_WIDTH => 32,
    ...
    mux_25_5_32_1_1_U266 : component srcnn_mux_25_5_32_1_1
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        din0_WIDTH => 32,
    ...
    mux_25_5_32_1_1_U267 : component srcnn_mux_25_5_32_1_1
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        din0_WIDTH => 32,
    ...
    mux_25_5_32_1_1_U268 : component srcnn_mux_25_5_32_1_1
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        din0_WIDTH => 32,
    ...
    acc2_1_address0 <= zext_ln95_fu_450_p1(2 - 1 downto 0);
    ...
    acc2_2_address0 <= zext_ln95_fu_450_p1(2 - 1 downto 0);
    ...
    acc2_3_address0 <= zext_ln95_fu_450_p1(2 - 1 downto 0);
    ...
    acc2_4_address0 <= zext_ln95_fu_450_p1(2 - 1 downto 0);
    ...
    acc2_5_address0 <= zext_ln95_fu_450_p1(2 - 1 downto 0);
    ...
    acc2_6_address0 <= zext_ln95_fu_450_p1(2 - 1 downto 0);
    ...
    acc2_7_address0 <= zext_ln95_fu_450_p1(2 - 1 downto 0);
    ...
    acc2_address0 <= zext_ln95_fu_450_p1(2 - 1 downto 0);
    ...
    add_ln95_fu_918_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_n2_1) + unsigned(ap_const_lv6_8));
    ...
    ap_sig_allocacmp_n2_1_assign_proc : process(ap_CS_fsm_state1, n2_fu_120, ap_loop_init)
    begin
    ...
    lshr_ln_fu_440_p4 <= ap_sig_allocacmp_n2_1(4 downto 3);
    tmp_fu_428_p3 <= ap_sig_allocacmp_n2_1(5 downto 5);
    trunc_ln95_fu_436_p1 <= ap_sig_allocacmp_n2_1(5 - 1 downto 0);
    zext_ln95_fu_450_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(lshr_ln_fu_440_p4),64));
end behav;
