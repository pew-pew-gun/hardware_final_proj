...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_s_pix_i \
    op interface \
    ports { s_pix_i_din { O 16 vector } s_pix_i_num_data_valid { I 11 vector } s_pix_i_fifo_cap { I 11 vector } s_pix_i_full_n { I 1 bit } s_pix_i_write { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_tw_eff_loc_i_c2 \
    op interface \
    ports { tw_eff_loc_i_c2_din { O 8 vector } tw_eff_loc_i_c2_num_data_valid { I 2 vector } tw_eff_loc_i_c2_fifo_cap { I 2 vector } tw_eff_loc_i_c2_full_n { I 1 bit } tw_eff_loc_i_c2_write { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_w0_c \
    op interface \
    ports { w0_c_din { O 8 vector } w0_c_num_data_valid { I 3 vector } w0_c_fifo_cap { I 3 vector } w0_c_full_n { I 1 bit } w0_c_write { O 1 bit } } \
} "
}
