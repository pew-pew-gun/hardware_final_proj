...
set C_modelArgList {
	...
	{ s_pix_i int 16 regular {fifo 1 volatile }  }
...
set C_modelArgMapList {[ 
	{ "Name" : "gmem_in", "interface" : "axi_master", "bitwidth" : 32, "direction" : "READONLY", "bitSlice":[ {"cElement": [{"cName": "input_ftmap","offset": { "type": "dynamic","port_name": "input_ftmap","bundle": "ctrl"},"direction": "READONLY"}]}]} , 
 	...
 	{ "Name" : "s_pix_i", "interface" : "fifo", "bitwidth" : 16, "direction" : "WRITEONLY"} , 
...
set portList { 
	...
	{ s_pix_i_din sc_out sc_lv 16 signal 5 } 
	...
	{ w0_c_din sc_out sc_lv 8 signal 7 } 
	{ w0_c_num_data_valid sc_in sc_lv 3 signal 7 } 
	{ w0_c_fifo_cap sc_in sc_lv 3 signal 7 } 
	{ w0_c_full_n sc_in sc_logic 1 signal 7 } 
	{ w0_c_write sc_out sc_logic 1 signal 7 } 
	{ h0_c5_din sc_out sc_lv 9 signal 8 } 
	{ h0_c5_num_data_valid sc_in sc_lv 2 signal 8 } 
	{ h0_c5_fifo_cap sc_in sc_lv 2 signal 8 } 
	{ h0_c5_full_n sc_in sc_logic 1 signal 8 } 
	{ h0_c5_write sc_out sc_logic 1 signal 8 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "s_pix_i_din", "direction": "out", "datatype": "sc_lv", "bitwidth":16, "type": "signal", "bundle":{"name": "s_pix_i", "role": "din" }} , 
 	...
 	{ "name": "w0_c_num_data_valid", "direction": "in", "datatype": "sc_lv", "bitwidth":3, "type": "signal", "bundle":{"name": "w0_c", "role": "num_data_valid" }} , 
 	{ "name": "w0_c_fifo_cap", "direction": "in", "datatype": "sc_lv", "bitwidth":3, "type": "signal", "bundle":{"name": "w0_c", "role": "fifo_cap" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		...
		"Port" : [
			...
			{"Name" : "w0_c", "Type" : "Fifo", "Direction" : "O", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "4", "DependentChanType" : "2",
				"BlockSignal" : [
					{"Name" : "w0_c_blk_n", "Type" : "RtlSignal"}]},
			{"Name" : "h0_c5", "Type" : "Fifo", "Direction" : "O", "DependentProc" : ["0","0"], "DependentChan" : "0", "DependentChanDepth" : "2", "DependentChanType" : "2",
				"BlockSignal" : [
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.fpext_32ns_64_2_no_dsp_1_U147", "Parent" : "0"}]}
...
set Spec2ImplPortList { 
	...
	s_pix_i { ap_fifo {  { s_pix_i_din fifo_port_we 1 16 }  { s_pix_i_num_data_valid fifo_status_num_data_valid 0 11 }  { s_pix_i_fifo_cap fifo_update 0 11 }  { s_pix_i_full_n fifo_status 0 1 }  { s_pix_i_write fifo_data 1 1 } } }
	...
	w0_c { ap_fifo {  { w0_c_din fifo_port_we 1 8 }  { w0_c_num_data_valid fifo_status_num_data_valid 0 3 }  { w0_c_fifo_cap fifo_update 0 3 }  { w0_c_full_n fifo_status 0 1 }  { w0_c_write fifo_data 1 1 } } }
