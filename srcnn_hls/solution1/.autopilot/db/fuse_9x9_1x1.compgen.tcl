...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler srcnn_fuse_9x9_1x1_acc2_RAM_AUTO_1R1W BINDTYPE {storage} TYPE {ram} IMPL {auto} LATENCY 2 ALLOW_PRAGMA 1
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_s_f2_i_i \
    op interface \
    ports { s_f2_i_i_din { O 1024 vector } s_f2_i_i_num_data_valid { I 7 vector } s_f2_i_i_fifo_cap { I 7 vector } s_f2_i_i_full_n { I 1 bit } s_f2_i_i_write { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_phase_c \
    op interface \
    ports { phase_c_din { O 1 vector } phase_c_num_data_valid { I 2 vector } phase_c_fifo_cap { I 2 vector } phase_c_full_n { I 1 bit } phase_c_write { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_w0_c \
    op interface \
    ports { w0_c_din { O 9 vector } w0_c_num_data_valid { I 2 vector } w0_c_fifo_cap { I 2 vector } w0_c_full_n { I 1 bit } w0_c_write { O 1 bit } } \
} "
}
