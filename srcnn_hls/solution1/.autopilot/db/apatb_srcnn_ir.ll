...
define void @apatb_srcnn_ir([255 x [255 x float]]* noalias nocapture nonnull readonly "fpga.decayed.dim.hint"="1" "maxi" %input_ftmap, [1 x [9 x [9 x float]]]* noalias nocapture nonnull readonly "fpga.decayed.dim.hint"="64" "maxi" %conv1_weights, float* noalias nocapture nonnull readonly "fpga.decayed.dim.hint"="64" "maxi" %conv1_biases, [64 x [1 x [1 x float]]]* noalias nocapture nonnull readonly "fpga.decayed.dim.hint"="32" "maxi" %conv2_weights, float* noalias nocapture nonnull readonly "fpga.decayed.dim.hint"="32" "maxi" %conv2_biases, [32 x [5 x [5 x float]]]* noalias nocapture nonnull readonly "fpga.decayed.dim.hint"="1" "maxi" %conv3_weights, float* noalias nocapture nonnull readonly "fpga.decayed.dim.hint"="1" "maxi" %conv3_biases, [255 x [255 x float]]* noalias nocapture nonnull "fpga.decayed.dim.hint"="1" "maxi" %output_ftmap, i1 zeroext %reload_weights) local_unnamed_addr #0 {
entry:
  ...
  call void @apatb_srcnn_hw([1 x [255 x [255 x float]]]* %input_ftmap_copy, [64 x [1 x [9 x [9 x float]]]]* %conv1_weights_copy, [64 x float]* %conv1_biases_copy, [32 x [64 x [1 x [1 x float]]]]* %conv2_weights_copy, [32 x float]* %conv2_biases_copy, [1 x [32 x [5 x [5 x float]]]]* %conv3_weights_copy, [1 x float]* %conv3_biases_copy, [1 x [255 x [255 x float]]]* %output_ftmap_copy, i1 %reload_weights)
...
declare void @apatb_srcnn_hw([1 x [255 x [255 x float]]]*, [64 x [1 x [9 x [9 x float]]]]*, [64 x float]*, [32 x [64 x [1 x [1 x float]]]]*, [32 x float]*, [1 x [32 x [5 x [5 x float]]]]*, [1 x float]*, [1 x [255 x [255 x float]]]*, i1)
...
define void @srcnn_hw_stub_wrapper([1 x [255 x [255 x float]]]*, [64 x [1 x [9 x [9 x float]]]]*, [64 x float]*, [32 x [64 x [1 x [1 x float]]]]*, [32 x float]*, [1 x [32 x [5 x [5 x float]]]]*, [1 x float]*, [1 x [255 x [255 x float]]]*, i1) #5 {
entry:
  ...
  call void @srcnn_hw_stub([255 x [255 x float]]* %9, [1 x [9 x [9 x float]]]* %10, float* %11, [64 x [1 x [1 x float]]]* %12, float* %13, [32 x [5 x [5 x float]]]* %14, float* %15, [255 x [255 x float]]* %16, i1 %8)
...
declare void @srcnn_hw_stub([255 x [255 x float]]*, [1 x [9 x [9 x float]]]*, float*, [64 x [1 x [1 x float]]]*, float*, [32 x [5 x [5 x float]]]*, float*, [255 x [255 x float]]*, i1)
