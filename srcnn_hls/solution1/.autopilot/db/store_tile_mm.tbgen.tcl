...
set portList { 
	...
	{ outbuf_address0 sc_out sc_lv 15 signal 5 } 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "3"],
		...
		"Port" : [
			...
			{"Name" : "gmem_out", "Type" : "MAXI", "Direction" : "O",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_store_tile_mm_Pipeline_Out_writex_fu_96", "Port" : "gmem_out", "Inst_start_state" : "2", "Inst_end_state" : "3"}]},
			...
			{"Name" : "outbuf", "Type" : "Memory", "Direction" : "I", "DependentProc" : ["0"], "DependentChan" : "0",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_store_tile_mm_Pipeline_Out_writex_fu_96", "Port" : "outbuf", "Inst_start_state" : "2", "Inst_end_state" : "3"}]}]},
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_store_tile_mm_Pipeline_Out_writex_fu_96", "Parent" : "0", "Child" : ["2"],
	...
	{"ID" : "2", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_store_tile_mm_Pipeline_Out_writex_fu_96.flow_control_loop_pipe_sequential_init_U", "Parent" : "1"},
	{"ID" : "3", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mul_8ns_8ns_16_1_1_U3513", "Parent" : "0"}]}
