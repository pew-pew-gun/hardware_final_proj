...
set portList { 
	...
	{ outbuf_d0 sc_out sc_lv 32 signal 5 } 
...
set NewPortList {[ 
	{ "name": "phase_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":1, "type": "signal", "bundle":{"name": "phase", "role": "dout" }} , 
 	...
 	{ "name": "outbuf_empty_n", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "outbuf_empty_n", "role": "default" }} , 
 	{ "name": "outbuf_read", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "outbuf_read", "role": "default" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2", "3", "7", "8", "9", "10", "11", "12", "13", "14"],
		"CDFG" : "store_tile_mm",
		"Protocol" : "ap_ctrl_hs",
		...
		"Port" : [
			...
			{"Name" : "w0", "Type" : "Fifo", "Direction" : "I", "DependentProc" : ["0","-1"], "DependentChan" : "0", "DependentChanDepth" : "2", "DependentChanType" : "2",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "entry_proc_U0", "Port" : "w0"}]},
			{"Name" : "outbuf", "Type" : "Memory", "Direction" : "I", "DependentProc" : ["0"], "DependentChan" : "0",
				"SubConnect" : [
					{"ID" : "3", "SubInstance" : "store_tile_mm_Loop_Out_writey_proc_U0", "Port" : "outbuf"}]}]},
	...
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.store_tile_mm_Block_entry23_proc_U0", "Parent" : "0",
		...
		"Port" : [
			...
			{"Name" : "h0", "Type" : "None", "Direction" : "I", "DependentProc" : ["1"], "DependentChan" : "9", "DependentChanDepth" : "2", "DependentChanType" : "1"},
			{"Name" : "w0", "Type" : "None", "Direction" : "I", "DependentProc" : ["1"], "DependentChan" : "8", "DependentChanDepth" : "2", "DependentChanType" : "1"}]},
	{"ID" : "3", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.store_tile_mm_Loop_Out_writey_proc_U0", "Parent" : "0", "Child" : ["4", "6"],
		"CDFG" : "store_tile_mm_Loop_Out_writey_proc",
		"Protocol" : "ap_ctrl_hs",
		"ControlExist" : "1", "ap_start" : "1", "ap_ready" : "1", "ap_done" : "1", "ap_continue" : "1", "ap_idle" : "1", "real_start" : "0",
		"Pipeline" : "None", "UnalignedPipeline" : "0", "RewindPipeline" : "0", "ProcessNetwork" : "0",
		"II" : "0",
		...
		"IsBlackBox" : "0",
		"Port" : [
			{"Name" : "p_read", "Type" : "None", "Direction" : "I", "DependentProc" : ["2"], "DependentChan" : "12", "DependentChanDepth" : "2", "DependentChanType" : "1"},
			{"Name" : "p_read1", "Type" : "None", "Direction" : "I", "DependentProc" : ["2"], "DependentChan" : "13", "DependentChanDepth" : "2", "DependentChanType" : "1"},
			{"Name" : "output_ftmap", "Type" : "Fifo", "Direction" : "I", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "4", "DependentChanType" : "2",
				"BlockSignal" : [
					{"Name" : "output_ftmap_blk_n", "Type" : "RtlSignal"}]},
			{"Name" : "h0", "Type" : "None", "Direction" : "I", "DependentProc" : ["1"], "DependentChan" : "10", "DependentChanDepth" : "3", "DependentChanType" : "1"},
			{"Name" : "w0", "Type" : "None", "Direction" : "I", "DependentProc" : ["1"], "DependentChan" : "7", "DependentChanDepth" : "3", "DependentChanType" : "1"},
			{"Name" : "gmem_out", "Type" : "MAXI", "Direction" : "O",
				"SubConnect" : [
					{"ID" : "4", "SubInstance" : "grp_store_tile_mm_Loop_Out_writey_proc_Pipeline_Out_writex_fu_116", "Port" : "gmem_out", "Inst_start_state" : "2", "Inst_end_state" : "3"}]},
			{"Name" : "p_read2", "Type" : "None", "Direction" : "I", "DependentProc" : ["2"], "DependentChan" : "14", "DependentChanDepth" : "2", "DependentChanType" : "1"},
			{"Name" : "p_read3", "Type" : "None", "Direction" : "I", "DependentProc" : ["2"], "DependentChan" : "11", "DependentChanDepth" : "2", "DependentChanType" : "1"},
			{"Name" : "outbuf", "Type" : "Memory", "Direction" : "I", "DependentProc" : ["0"], "DependentChan" : "0",
				"SubConnect" : [
					{"ID" : "4", "SubInstance" : "grp_store_tile_mm_Loop_Out_writey_proc_Pipeline_Out_writex_fu_116", "Port" : "outbuf", "Inst_start_state" : "2", "Inst_end_state" : "3"}]}]},
	{"ID" : "4", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.store_tile_mm_Loop_Out_writey_proc_U0.grp_store_tile_mm_Loop_Out_writey_proc_Pipeline_Out_writex_fu_116", "Parent" : "3", "Child" : ["5"],
		"CDFG" : "store_tile_mm_Loop_Out_writey_proc_Pipeline_Out_writex",
		"Protocol" : "ap_ctrl_hs",
		...
		"Port" : [
			...
			{"Name" : "select_ln532", "Type" : "None", "Direction" : "I"},
			{"Name" : "p_read2", "Type" : "None", "Direction" : "I"},
			{"Name" : "p_read1", "Type" : "None", "Direction" : "I"},
			{"Name" : "output_ftmap_load", "Type" : "None", "Direction" : "I"},
	...
	{"ID" : "5", "Level" : "3", "Path" : "`AUTOTB_DUT_INST.store_tile_mm_Loop_Out_writey_proc_U0.grp_store_tile_mm_Loop_Out_writey_proc_Pipeline_Out_writex_fu_116.flow_control_loop_pipe_sequential_init_U", "Parent" : "4"},
	{"ID" : "6", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.store_tile_mm_Loop_Out_writey_proc_U0.mul_8ns_8ns_16_1_1_U2330", "Parent" : "3"},
	{"ID" : "7", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.tmp_1_U", "Parent" : "0"},
	{"ID" : "8", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.tmp_2_U", "Parent" : "0"},
	{"ID" : "9", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.tmp_3_U", "Parent" : "0"},
	{"ID" : "10", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.tmp_4_U", "Parent" : "0"},
	{"ID" : "11", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.out_tile_offset_cast_loc_i_i_channel_U", "Parent" : "0"},
	{"ID" : "12", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.h0_cast6_loc_i_i_channel_U", "Parent" : "0"},
	{"ID" : "13", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.shl_ln333_cast_loc_i_i_channel_U", "Parent" : "0"},
	{"ID" : "14", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.p_cast_loc_i_i_channel_U", "Parent" : "0"}]}
...
set ArgLastReadFirstWriteLatency {
	...
	store_tile_mm_Block_entry23_proc {
		...
		h0 {Type I LastRead 0 FirstWrite -1}
		w0 {Type I LastRead 0 FirstWrite -1}}
	store_tile_mm_Loop_Out_writey_proc {
		...
		outbuf {Type I LastRead 0 FirstWrite -1}}
	store_tile_mm_Loop_Out_writey_proc_Pipeline_Out_writex {
		p_read {Type I LastRead 0 FirstWrite -1}
		bound {Type I LastRead 0 FirstWrite -1}
		p_read3 {Type I LastRead 0 FirstWrite -1}
		gmem_out {Type O LastRead 3 FirstWrite 2}
		select_ln532 {Type I LastRead 0 FirstWrite -1}
		p_read2 {Type I LastRead 0 FirstWrite -1}
		p_read1 {Type I LastRead 0 FirstWrite -1}
		output_ftmap_load {Type I LastRead 0 FirstWrite -1}
		outbuf {Type I LastRead 0 FirstWrite -1}}}
...
set Spec2ImplPortList { 
	phase { ap_fifo {  { phase_dout fifo_port_we 0 1 }  { phase_empty_n fifo_status 0 1 }  { phase_read fifo_data 1 1 } } }
	...
	output_ftmap { ap_fifo {  { output_ftmap_dout fifo_port_we 0 64 }  { output_ftmap_empty_n fifo_status 0 1 }  { output_ftmap_read fifo_data 1 1 } } }
	h0 { ap_fifo {  { h0_dout fifo_port_we 0 9 }  { h0_empty_n fifo_status 0 1 }  { h0_read fifo_data 1 1 } } }
	w0 { ap_fifo {  { w0_dout fifo_port_we 0 8 }  { w0_empty_n fifo_status 0 1 }  { w0_read fifo_data 1 1 } } }
	outbuf { ap_memory {  { outbuf_address0 mem_address 1 9 }  { outbuf_ce0 mem_ce 1 1 }  { outbuf_d0 mem_din 1 32 }  { outbuf_q0 mem_dout 0 32 }  { outbuf_we0 mem_we 1 1 } } }
}
