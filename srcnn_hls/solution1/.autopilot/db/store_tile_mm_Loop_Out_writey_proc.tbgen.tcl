set moduleName store_tile_mm_Loop_Out_writey_proc
set isTopModule 0
...
set C_modelName {store_tile_mm_Loop_Out_writey_proc}
...
set portList { 
	...
	{ outbuf_address0 sc_out sc_lv 9 signal 8 } 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "3"],
		...
		"Port" : [
			...
			{"Name" : "h0", "Type" : "None", "Direction" : "I", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "3", "DependentChanType" : "1"},
			{"Name" : "w0", "Type" : "None", "Direction" : "I", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "3", "DependentChanType" : "1"},
			{"Name" : "gmem_out", "Type" : "MAXI", "Direction" : "O",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_store_tile_mm_Loop_Out_writey_proc_Pipeline_Out_writex_fu_116", "Port" : "gmem_out", "Inst_start_state" : "2", "Inst_end_state" : "3"}]},
			...
			{"Name" : "outbuf", "Type" : "Memory", "Direction" : "I", "DependentProc" : ["0"], "DependentChan" : "0",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_store_tile_mm_Loop_Out_writey_proc_Pipeline_Out_writex_fu_116", "Port" : "outbuf", "Inst_start_state" : "2", "Inst_end_state" : "3"}]}]},
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_store_tile_mm_Loop_Out_writey_proc_Pipeline_Out_writex_fu_116", "Parent" : "0", "Child" : ["2"],
	...
	{"ID" : "2", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_store_tile_mm_Loop_Out_writey_proc_Pipeline_Out_writex_fu_116.flow_control_loop_pipe_sequential_init_U", "Parent" : "1"},
	{"ID" : "3", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mul_8ns_8ns_16_1_1_U2330", "Parent" : "0"}]}
