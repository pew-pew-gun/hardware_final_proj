set SynModuleInfo {
  ...
  {SRCNAME make_win97 MODELNAME make_win97 RTLNAME srcnn_make_win97
    SUBMODULES {
      ...
      {MODELNAME srcnn_make_win97_lb1_RAM_2P_BRAM_1R1W RTLNAME srcnn_make_win97_lb1_RAM_2P_BRAM_1R1W BINDTYPE storage TYPE ram_2p IMPL bram LATENCY 2 ALLOW_PRAGMA 1}
    }
  }
  {SRCNAME conv1conv2_from_windows8_Pipeline_Init_Conv2Out_biases MODELNAME conv1conv2_from_windows8_Pipeline_Init_Conv2Out_biases RTLNAME srcnn_conv1conv2_from_windows8_Pipeline_Init_Conv2Out_biases
    SUBMODULES {
      {MODELNAME srcnn_mux_25_5_16_1_1 RTLNAME srcnn_mux_25_5_16_1_1 BINDTYPE op TYPE mux IMPL auto LATENCY 0 ALLOW_PRAGMA 1}
    }
  }
  {SRCNAME conv1conv2_from_windows8_Pipeline_Conv1_outftmaps MODELNAME conv1conv2_from_windows8_Pipeline_Conv1_outftmaps RTLNAME srcnn_conv1conv2_from_windows8_Pipeline_Conv1_outftmaps
    SUBMODULES {
      {MODELNAME srcnn_mux_64_6_16_1_1 RTLNAME srcnn_mux_64_6_16_1_1 BINDTYPE op TYPE mux IMPL auto LATENCY 0 ALLOW_PRAGMA 1}
      {MODELNAME srcnn_mul_16s_16ns_32_1_1 RTLNAME srcnn_mul_16s_16ns_32_1_1 BINDTYPE op TYPE mul IMPL auto LATENCY 0 ALLOW_PRAGMA 1}
      {MODELNAME srcnn_mul_23ns_16s_39_1_1 RTLNAME srcnn_mul_23ns_16s_39_1_1 BINDTYPE op TYPE mul IMPL auto LATENCY 0 ALLOW_PRAGMA 1}
    }
  }
  ...
  {SRCNAME conv1conv2_stream4 MODELNAME conv1conv2_stream4 RTLNAME srcnn_conv1conv2_stream4
    SUBMODULES {
      ...
      {MODELNAME srcnn_fifo_w1297_d1024_A RTLNAME srcnn_fifo_w1297_d1024_A BINDTYPE storage TYPE fifo IMPL memory ALLOW_PRAGMA 1 INSTNAME s_win_i_U}
  ...
  {SRCNAME conv3_stream5_Pipeline_Conv3_ky MODELNAME conv3_stream5_Pipeline_Conv3_ky RTLNAME srcnn_conv3_stream5_Pipeline_Conv3_ky
    SUBMODULES {
      {MODELNAME srcnn_mux_5_3_16_1_1 RTLNAME srcnn_mux_5_3_16_1_1 BINDTYPE op TYPE mux IMPL auto LATENCY 0 ALLOW_PRAGMA 1}
      {MODELNAME srcnn_mul_16ns_16s_32_1_1 RTLNAME srcnn_mul_16ns_16s_32_1_1 BINDTYPE op TYPE mul IMPL auto LATENCY 0 ALLOW_PRAGMA 1}
    }
  }
  {SRCNAME conv3_stream5 MODELNAME conv3_stream5 RTLNAME srcnn_conv3_stream5
    SUBMODULES {
      ...
      {MODELNAME srcnn_conv3_stream5_lb2_RAM_2P_BRAM_1R1W RTLNAME srcnn_conv3_stream5_lb2_RAM_2P_BRAM_1R1W BINDTYPE storage TYPE ram_2p IMPL bram LATENCY 2 ALLOW_PRAGMA 1}
    }
  }
  ...
  {SRCNAME dataflow_in_loop_IT_w0.1 MODELNAME dataflow_in_loop_IT_w0_1 RTLNAME srcnn_dataflow_in_loop_IT_w0_1
    SUBMODULES {
      ...
      {MODELNAME srcnn_fifo_w16_d1024_A RTLNAME srcnn_fifo_w16_d1024_A BINDTYPE storage TYPE fifo IMPL memory ALLOW_PRAGMA 1 INSTNAME s_pix_U}
      ...
      {MODELNAME srcnn_fifo_w8_d4_S RTLNAME srcnn_fifo_w8_d4_S BINDTYPE storage TYPE fifo IMPL srl ALLOW_PRAGMA 1 INSTNAME w0_c_U}
      ...
      {MODELNAME srcnn_fifo_w512_d1024_A RTLNAME srcnn_fifo_w512_d1024_A BINDTYPE storage TYPE fifo IMPL memory ALLOW_PRAGMA 1 INSTNAME s_f2_i_U}
      ...
      {MODELNAME srcnn_fifo_w9_d2_S_x RTLNAME srcnn_fifo_w9_d2_S_x BINDTYPE storage TYPE fifo IMPL srl ALLOW_PRAGMA 1 INSTNAME h0_c4_U}
      {MODELNAME srcnn_fifo_w24_d1024_A RTLNAME srcnn_fifo_w24_d1024_A BINDTYPE storage TYPE fifo IMPL memory ALLOW_PRAGMA 1 INSTNAME s_out_U}
  ...
  {SRCNAME srcnn MODELNAME srcnn RTLNAME srcnn IS_TOP 1
    SUBMODULES {
      {MODELNAME srcnn_fpext_32ns_64_2_no_dsp_1 RTLNAME srcnn_fpext_32ns_64_2_no_dsp_1 BINDTYPE op TYPE fpext IMPL auto LATENCY 1 ALLOW_PRAGMA 1}
      {MODELNAME srcnn_p_ZZ5srcnnPA255_A255_fPA1_A9_A9_fPfPA64_A1_A1_fS6_PA32_A5_A5_fS6_S1_bE6w1_locbkb RTLNAME srcnn_p_ZZ5srcnnPA255_A255_fPA1_A9_A9_fPfPA64_A1_A1_fS6_PA32_A5_A5_fS6_S1_bE6w1_locbkb BINDTYPE storage TYPE ram_1p IMPL lutram LATENCY 2 ALLOW_PRAGMA 1}
      ...
      {MODELNAME srcnn_p_ZZ5srcnnPA255_A255_fPA1_A9_A9_fPfPA64_A1_A1_fS6_PA32_A5_A5_fS6_S1_bE6w3_locbun RTLNAME srcnn_p_ZZ5srcnnPA255_A255_fPA1_A9_A9_fPfPA64_A1_A1_fS6_PA32_A5_A5_fS6_S1_bE6w3_locbun BINDTYPE storage TYPE ram_2p IMPL bram LATENCY 2 ALLOW_PRAGMA 1}
