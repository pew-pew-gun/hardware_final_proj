set moduleName srcnn_Pipeline_VITIS_LOOP_346_2_VITIS_LOOP_348_3
set isTopModule 0
...
set C_modelName {srcnn_Pipeline_VITIS_LOOP_346_2_VITIS_LOOP_348_3}
set C_modelType { void 0 }
set C_modelArgList {
	{ gmem_w1 int 32 regular {axi_master 0}  }
	{ add_ln350_3 int 11 regular  }
	{ sext_ln344 int 62 regular  }
	{ zext_ln344_3 int 13 regular  }
	{ w1_loc float 32 regular {array 5184 { 0 } 0 1 stable  } {global 1}  }
}
set hasAXIMCache 0
set C_modelArgMapList {[ 
	{ "Name" : "gmem_w1", "interface" : "axi_master", "bitwidth" : 32, "direction" : "READONLY", "bitSlice":[ {"cElement": [{"cName": "conv1_weights","offset": { "type": "dynamic","port_name": "conv1_weights","bundle": "ctrl"},"direction": "READONLY"},{"cName": "conv1_biases","offset": { "type": "dynamic","port_name": "conv1_biases","bundle": "ctrl"},"direction": "READONLY"}]}]} , 
 	{ "Name" : "add_ln350_3", "interface" : "wire", "bitwidth" : 11, "direction" : "READONLY"} , 
 	{ "Name" : "sext_ln344", "interface" : "wire", "bitwidth" : 62, "direction" : "READONLY"} , 
 	{ "Name" : "zext_ln344_3", "interface" : "wire", "bitwidth" : 13, "direction" : "READONLY"} , 
 	{ "Name" : "w1_loc", "interface" : "memory", "bitwidth" : 32, "direction" : "WRITEONLY", "extern" : 0} ]}
...
set portList { 
	...
	{ add_ln350_3 sc_in sc_lv 11 signal 1 } 
	{ sext_ln344 sc_in sc_lv 62 signal 2 } 
	{ zext_ln344_3 sc_in sc_lv 13 signal 3 } 
	{ w1_loc_address0 sc_out sc_lv 13 signal 4 } 
	{ w1_loc_ce0 sc_out sc_logic 1 signal 4 } 
	{ w1_loc_we0 sc_out sc_logic 1 signal 4 } 
	{ w1_loc_d0 sc_out sc_lv 32 signal 4 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "add_ln350_3", "direction": "in", "datatype": "sc_lv", "bitwidth":11, "type": "signal", "bundle":{"name": "add_ln350_3", "role": "default" }} , 
 	{ "name": "sext_ln344", "direction": "in", "datatype": "sc_lv", "bitwidth":62, "type": "signal", "bundle":{"name": "sext_ln344", "role": "default" }} , 
 	{ "name": "zext_ln344_3", "direction": "in", "datatype": "sc_lv", "bitwidth":13, "type": "signal", "bundle":{"name": "zext_ln344_3", "role": "default" }} , 
...
set Spec2ImplPortList { 
	...
	add_ln350_3 { ap_none {  { add_ln350_3 in_data 0 11 } } }
	sext_ln344 { ap_none {  { sext_ln344 in_data 0 62 } } }
	zext_ln344_3 { ap_none {  { zext_ln344_3 in_data 0 13 } } }
	w1_loc { ap_memory {  { w1_loc_address0 mem_address 1 13 }  { w1_loc_ce0 mem_ce 1 1 }  { w1_loc_we0 mem_we 1 1 }  { w1_loc_d0 mem_din 1 32 } } }
}
