...
"SubInsts" : [
	{"Name" : "grp_srcnn_Pipeline_CopyW3_inft_CopyW3_ky_CopyW3_kx_fu_1215","ID" : "1","Type" : "sequential",
		"SubLoops" : [
		{"Name" : "CopyW3_inft_CopyW3_ky_CopyW3_kx","ID" : "2","Type" : "pipeline"},]},],
"SubLoops" : [
	{"Name" : "CopyW1_outft","ID" : "3","Type" : "no",
	"SubInsts" : [
	{"Name" : "grp_srcnn_Pipeline_CopyW1_ky_CopyW1_kx_fu_1018","ID" : "4","Type" : "sequential",
			"SubLoops" : [
			{"Name" : "CopyW1_ky_CopyW1_kx","ID" : "5","Type" : "pipeline"},]},]},
	{"Name" : "CopyW2_outft","ID" : "6","Type" : "no",
	"SubInsts" : [
	{"Name" : "grp_srcnn_Pipeline_CopyW2_inft_fu_1189","ID" : "7","Type" : "sequential",
			"SubLoops" : [
	...
	{"Name" : "IT_w0","ID" : "10","Type" : "no",
		"SubInsts" : [
		{"Name" : "grp_dataflow_in_loop_IT_w0_1_fu_1302","ID" : "11","Type" : "dataflow",
				"SubInsts" : [
				...
				{"Name" : "conv1conv2_stream4_U0","ID" : "16","Type" : "dataflow",
					...
					{"Name" : "conv1conv2_from_windows8_U0","ID" : "21","Type" : "sequential",
						...
						"SubInsts" : [
						{"Name" : "grp_conv1conv2_from_windows8_Pipeline_Init_Conv2Out_biases_fu_1554","ID" : "23","Type" : "sequential",
								"SubLoops" : [
								{"Name" : "Init_Conv2Out_biases","ID" : "24","Type" : "pipeline"},]},
						{"Name" : "grp_conv1conv2_from_windows8_Pipeline_Conv1_outftmaps_fu_1598","ID" : "25","Type" : "sequential",
								"SubLoops" : [
								{"Name" : "Conv1_outftmaps","ID" : "26","Type" : "pipeline"},]},
						{"Name" : "grp_conv1conv2_from_windows8_Pipeline_Push_conv2pix_out_fu_2005","ID" : "27","Type" : "sequential",
								"SubLoops" : [
				...
				{"Name" : "conv3_stream5_U0","ID" : "29","Type" : "sequential",
					...
					"SubInsts" : [
					{"Name" : "grp_conv3_stream5_Pipeline_Conv3_ky_fu_3917","ID" : "31","Type" : "sequential",
							"SubLoops" : [
							{"Name" : "Conv3_ky","ID" : "32","Type" : "pipeline"},]},]},]},
				{"Name" : "entry_proc16_U0","ID" : "33","Type" : "sequential"},
				{"Name" : "store_stream6_U0","ID" : "34","Type" : "sequential",
					"SubLoops" : [
