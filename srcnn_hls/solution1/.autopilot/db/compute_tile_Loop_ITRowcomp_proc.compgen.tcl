...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler srcnn_compute_tile_Loop_ITRowcomp_proc_linebuf_RAM_2P_BRAM_1R1W BINDTYPE {storage} TYPE {ram_2p} IMPL {bram} LATENCY 2 ALLOW_PRAGMA 1
}


if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler srcnn_compute_tile_Loop_ITRowcomp_proc_f2_RAM_AUTO_1R1W BINDTYPE {storage} TYPE {ram} IMPL {auto} LATENCY 2 ALLOW_PRAGMA 1
}


if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler srcnn_compute_tile_Loop_ITRowcomp_proc_win_RAM_AUTO_1R1W BINDTYPE {storage} TYPE {ram} IMPL {auto} LATENCY 2 ALLOW_PRAGMA 1
}
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename out_tile \
    op interface \
    ports { out_tile_address0 { O 9 vector } out_tile_ce0 { O 1 bit } out_tile_we0 { O 1 bit } out_tile_d0 { O 32 vector } } \
} "
} else {
