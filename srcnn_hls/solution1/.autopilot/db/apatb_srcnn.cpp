...
#define AUTOTB_TVOUT_conv1_weights "../tv/cdatafile/c.srcnn.autotvout_conv1_weights.dat"
#define AUTOTB_TVIN_conv1_biases "../tv/cdatafile/c.srcnn.autotvin_conv1_biases.dat"
#define AUTOTB_TVOUT_conv1_biases "../tv/cdatafile/c.srcnn.autotvout_conv1_biases.dat"
#define AUTOTB_TVIN_conv2_weights "../tv/cdatafile/c.srcnn.autotvin_conv2_weights.dat"
#define AUTOTB_TVOUT_conv2_weights "../tv/cdatafile/c.srcnn.autotvout_conv2_weights.dat"
#define AUTOTB_TVIN_conv2_biases "../tv/cdatafile/c.srcnn.autotvin_conv2_biases.dat"
#define AUTOTB_TVOUT_conv2_biases "../tv/cdatafile/c.srcnn.autotvout_conv2_biases.dat"
...
#define AUTOTB_TVOUT_gmem_w1 "../tv/cdatafile/c.srcnn.autotvout_gmem_w1.dat"
#define AUTOTB_TVIN_gmem_w2 "../tv/cdatafile/c.srcnn.autotvin_gmem_w2.dat"
#define AUTOTB_TVOUT_gmem_w2 "../tv/cdatafile/c.srcnn.autotvout_gmem_w2.dat"
#define AUTOTB_TVIN_gmem_w3 "../tv/cdatafile/c.srcnn.autotvin_gmem_w3.dat"
#define AUTOTB_TVOUT_gmem_w3 "../tv/cdatafile/c.srcnn.autotvout_gmem_w3.dat"


// tvout file define:
#define AUTOTB_TVOUT_PC_gmem_in "../tv/rtldatafile/rtl.srcnn.autotvout_gmem_in.dat"
#define AUTOTB_TVOUT_PC_gmem_out "../tv/rtldatafile/rtl.srcnn.autotvout_gmem_out.dat"
#define AUTOTB_TVOUT_PC_gmem_w1 "../tv/rtldatafile/rtl.srcnn.autotvout_gmem_w1.dat"
#define AUTOTB_TVOUT_PC_gmem_w2 "../tv/rtldatafile/rtl.srcnn.autotvout_gmem_w2.dat"
#define AUTOTB_TVOUT_PC_gmem_w3 "../tv/rtldatafile/rtl.srcnn.autotvout_gmem_w3.dat"
...
void apatb_srcnn_hw(void* __xlx_apatb_param_input_ftmap, void* __xlx_apatb_param_conv1_weights, void* __xlx_apatb_param_conv1_biases, void* __xlx_apatb_param_conv2_weights, void* __xlx_apatb_param_conv2_biases, void* __xlx_apatb_param_conv3_weights, void* __xlx_apatb_param_conv3_biases, void* __xlx_apatb_param_output_ftmap)
{
  ...
  port0.param = &__xlx_offset_byte_param_input_ftmap;
  ...
  port1.param = &__xlx_offset_byte_param_conv1_weights;

  hls::sim::Byte<4> __xlx_offset_byte_param_conv1_biases;
...
#else
    .owriter = nullptr,
    .iwriter = new hls::sim::Writer(AUTOTB_TVIN_conv1_biases),
#endif
  };
  port2.param = &__xlx_offset_byte_param_conv1_biases;
  ...
  hls::sim::Byte<4> __xlx_offset_byte_param_conv2_biases;
...
#else
    .owriter = nullptr,
    .iwriter = new hls::sim::Writer(AUTOTB_TVIN_conv2_biases),
#endif
  };
  port4.param = &__xlx_offset_byte_param_conv2_biases;
  ...
  port5.param = &__xlx_offset_byte_param_conv3_weights;

  hls::sim::Byte<4> __xlx_offset_byte_param_conv3_biases;
  ...
  port6.param = &__xlx_offset_byte_param_conv3_biases;

  hls::sim::Byte<4> __xlx_offset_byte_param_output_ftmap;
  ...
  static hls::sim::Memory<hls::sim::Reader, hls::sim::Writer> port8 {
    ...
    .owriter = nullptr,
#ifdef USE_BINARY_TV_FILE
    .iwriter = new hls::sim::Output(AUTOTB_TVIN_gmem_in),
#else
    .iwriter = new hls::sim::Writer(AUTOTB_TVIN_gmem_in),
#endif
#endif
  };
...
#ifdef POST_CHECK
#ifdef USE_BINARY_TV_FILE
    .reader = new hls::sim::Input(AUTOTB_TVOUT_PC_gmem_out),
#else
    .reader = new hls::sim::Reader(AUTOTB_TVOUT_PC_gmem_out),
#endif
#else
#ifdef USE_BINARY_TV_FILE
    .owriter = new hls::sim::Output(AUTOTB_TVOUT_gmem_out),
#else
    .owriter = new hls::sim::Writer(AUTOTB_TVOUT_gmem_out),
#endif
#ifdef USE_BINARY_TV_FILE
    .iwriter = new hls::sim::Output(AUTOTB_TVIN_gmem_out),
#else
    .iwriter = new hls::sim::Writer(AUTOTB_TVIN_gmem_out),
#endif
#endif
  };
  ...
  static hls::sim::Memory<hls::sim::Reader, hls::sim::Writer> port10 {
    ...
    .owriter = nullptr,
#ifdef USE_BINARY_TV_FILE
    .iwriter = new hls::sim::Output(AUTOTB_TVIN_gmem_w1),
#else
    .iwriter = new hls::sim::Writer(AUTOTB_TVIN_gmem_w1),
#endif
#endif
  };
  ...
  static hls::sim::Memory<hls::sim::Reader, hls::sim::Writer> port11 {
    ...
    .owriter = nullptr,
#ifdef USE_BINARY_TV_FILE
    .iwriter = new hls::sim::Output(AUTOTB_TVIN_gmem_w2),
#else
    .iwriter = new hls::sim::Writer(AUTOTB_TVIN_gmem_w2),
#endif
#endif
  };
  ...
  static hls::sim::Memory<hls::sim::Reader, hls::sim::Writer> port12 {
    ...
    .owriter = nullptr,
#ifdef USE_BINARY_TV_FILE
    .iwriter = new hls::sim::Output(AUTOTB_TVIN_gmem_w3),
#else
    .iwriter = new hls::sim::Writer(AUTOTB_TVIN_gmem_w3),
#endif
#endif
  };
